...
with tf.device("/GPU:0"):
    ...
    bs_model_linear.pre_train_model(epochs = None, x = train_ds, data = None, n_train = n_train, shuffle = True)
    bs_model_linear.train_model(epochs = 50, x = train_ds, data = None, n_train = n_train,
                                shuffle = True,
...
bs_model_linear.hessian_jitter = 1.0e-6
bs_model_linear.save_model( "bs_final" )